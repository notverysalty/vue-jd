<template>
  <section class="container">
    <!-- <div class="row" v-for="item in items" :key="item.id">
      ...
      <div class="benifit">
        <span>{{ item.benifit }}</span>
        <img src="//m.jr.jd.com/spe/qyy/main/images/icon_arrow1.png" alt="">
      </div>
      
    </div> -->
    <List v-for="item in items" :key="item.id" :item="item"></List>
  </section>
</template>
        ...
        items: [
          {
            ...
            id: 7,
            src: '//img12.360buyimg.com/jrpmobile/jfs/t1/18738/31/15049/5408/5cadb703E039f2599/e92ce5b31d8b1ecf.png?width=70&height=70',
            name: '兑换优惠券',
            benifit: '去兑换'
          }, {
            id: 8,
